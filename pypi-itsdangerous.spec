...
%prep
%setup -q -n itsdangerous-2.2.0
cd %{_builddir}/itsdangerous-2.2.0
pushd ..
cp -a itsdangerous-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730208013
...
cp %{_builddir}/itsdangerous-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-itsdangerous/a814758bca3dc0a25555dabbf2576cdc43cd8423 || :
